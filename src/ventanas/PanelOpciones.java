...
/**
 * PanelOpciones: Clase que define el panel de opciones disponibles para el usuario.
 * 
 * Este panel proporciona varias opciones para que el usuario interactúe con su cuenta,
 * como consultar saldo, retirar, depositar, transferir, cambiar contraseña y crear cuentas adicionales.
 * También muestra un registro de eventos asociados con la cuenta seleccionada.
 * 
 * @author Eugenia
 */
public class PanelOpciones extends javax.swing.JPanel {
    ...
    public PanelOpciones(GestorCuenta gestionador, JFrame panelPrincipal) {
        ...
        // Configurar el ComboBox de seleccionar cuenta
        ...
        // ItemListener para el ComboBox de seleccionar cuenta
        ...
        // ActionListener para el botón de consultar saldo
        ...
        // ActionListener para el botón de retirar
        btnRetirar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {

                PanelDivisaRetirar panelRetirar = new PanelDivisaRetirar(gestionador, PanelOpciones.this, modeloTabla, panelPrincipal);
            }

        });

        // ActionListener para el botón de depositar
        btnDepositar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {

                PanelDivisaDepositar panelDepositar = new PanelDivisaDepositar(gestionador, PanelOpciones.this, modeloTabla, panelPrincipal);

            }

        });

        // ActionListener para el botón de transferir
        btnTransferir.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {

                PanelDivisaTransferir panelTransferir = new PanelDivisaTransferir(gestionador, PanelOpciones.this, modeloTabla, panelPrincipal);
            }

        });

        // ActionListener para el botón de cambiar contraseña
        btnCambiarContrasena.addActionListener(new ActionListener() {
         ...
         // ActionListener para el botón de crear cuenta adicional
     ...
     // ActionListener para actualizar la tabla
