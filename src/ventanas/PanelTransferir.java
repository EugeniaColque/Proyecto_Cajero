...
/**
 * PanelTransferir: Clase que define el panel para realizar transferencias de saldo.
 * 
 * Este panel proporciona la interfaz de usuario para transferir saldo de una cuenta a otra.
 * 
 * @author Eugenia
 */
public class PanelTransferir extends javax.swing.JPanel {
     ...
     * 
     * @param divisa La divisa en la que se realizará la transferencia.
     * @param gestionador El gestor de cuentas utilizado para manejar las operaciones de cuenta.
     * @param panelOpciones El panel que contiene las opciones del usuario.
    ...
    public PanelTransferir(String divisa, GestorCuenta gestionador, Container panelOpciones, DefaultTableModel registro, JFrame panelPrincipal) {
        ...
        btnTranferir.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (montoExistente >= montoATranferir) {
                    ...
                    gestionador.crearEvento(new Evento(numCuenta, "Se realizó una transferencia externa desde la cuenta: "+gestionador.getNroCuenta(), Double.toString(montoConvertidoDestino), gestionador.saldoDisponible()));
        ...
        // ActionListener para el botón de regresar
