...
/**
 * PanelDivisaDepositar: Clase que define un panel para seleccionar la divisa y realizar depósitos.
 * 
 * Permite al usuario seleccionar la divisa en la que desea realizar un depósito y luego 
 * redirige al panel correspondiente para completar la operación de depósito.
 * 
 * @author Eugenia
 */
public class PanelDivisaDepositar extends javax.swing.JPanel {
     ...
     * 
     * @param gestionador El gestor de cuentas utilizado para manejar las operaciones de depósito.
    ...
    public PanelDivisaDepositar(GestorCuenta gestionador, Container panelOpciones, DefaultTableModel registro, JFrame panelPrincipal) {
        ...
        // ActionListener para el botón de depositar en bolivianos
        ...
        // ActionListener para el botón de depositar en dólares
        btnDepositarDolares.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e) {
                PanelDepositar panelDepositar = new PanelDepositar("Dólares", gestionador, panelOpciones, registro, panelPrincipal);
            }
        });
        
        // ActionListener para el botón de depositar en euros
