...
/**
 * PanelRetirar: Clase que define el panel para realizar retiros de la cuenta.
 * 
 * Este panel permite al usuario retirar fondos de su cuenta en la divisa especificada.
 * 
 * @author Eugenia
 */
public class PanelRetirar extends javax.swing.JPanel {
     ...
     * 
     * @param divisa La divisa en la que se realizará el retiro.
     * @param gestionador El gestor de cuentas utilizado para manejar las operaciones de cuenta.
     * @param panelOpciones El panel de opciones principal al que se debe volver después de realizar el retiro.
     * @param registro El modelo de tabla que contiene el registro de eventos.
